/**
 * Parent Child Timetable Screen
 *
 * Displays weekly timetable from Pronote for a specific child.
 */
...
import { useChildTimetable, useParentDashboard } from '@/hooks';
        ...
        {isLoading ? (
          ...
          <View className="items-center py-12">
            <View className="mb-4 h-16 w-16 items-center justify-center rounded-full bg-muted">
              <Clock color="hsl(215.4, 16.3%, 46.9%)" size={32} />
            </View>
                      ...
                      >
                        <View className="flex-row items-start gap-3">
                          ...
                          <View className="flex-1">
                            <View className="flex-row items-center gap-2">
                              <Text
                                className={`font-semibold ${isCancelled ? 'line-through text-red-600' : ''}`}
                              >
                                {entry.subject ?? 'Cours'}
                              </Text>
                              {isCancelled && (
