...
export default function ResetPasswordScreen() {
  ...
  // Derived directly from the URL param — avoids the legacy useEffect +
  // setTokenValid pattern that fails react-hooks/set-state-in-effect.
  ...
  return (
    <AuthScreen>
      ...
      <View className="gap-4">
        ...
        <Button onPress={handleResetPassword} isLoading={isLoading} className="mt-4">
          Confirmer le mot de passe
        </Button>
      </View>
    </AuthScreen>
