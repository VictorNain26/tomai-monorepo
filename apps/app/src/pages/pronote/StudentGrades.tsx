/**
 * Student Grades Page - Display student's own grades from Pronote
 *
 * Student view to see their grades (read-only).
 * Uses the useStudentGrades hook.
 */
...
import { useStudentGrades, useStudentPronoteStatus } from '@/hooks/useStudentPronote';
...
export default function StudentGrades() {
  ...
  // Fetch grades
  const { data: grades, isLoading, error } = useStudentGrades(isConnected);
