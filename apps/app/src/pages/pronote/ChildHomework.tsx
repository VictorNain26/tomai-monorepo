/**
 * Child Homework Page - Display child's homework from Pronote
 *
 * Parent view to see their child's homework assignments.
 * Uses the useChildHomework hook with week navigation.
 */
...
import { useChildHomework } from '@/hooks/useParentPronote';
...
export default function ChildHomework() {
  ...
  // Fetch homework
  const { data: homework, isLoading, error } = useChildHomework(childId, weekOffset);
